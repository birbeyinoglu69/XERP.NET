...
namespace XERP
{
    ...
    [Persistent("ir_exports")]
	public partial class ir_exports : XPCustomObject
	{
		#region Properties
		...
		#region Constructors
		public ir_exports(Session session) : base(session) { }
        #endregion
