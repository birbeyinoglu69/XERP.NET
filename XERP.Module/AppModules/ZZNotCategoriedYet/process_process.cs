...
namespace XERP
{
    ...
    [Persistent("process_process")]
	public partial class process_process : XPCustomObject
	{
		#region Properties
		...
		public System.Int32 id {
            ...
            //FK FK_process_process_create_uid
            ...
            //FK FK_process_process_write_uid
            ...
            //FK FK_process_process_model_id
		...
		#region Constructors
		public process_process(Session session) : base(session) { }
        #endregion
