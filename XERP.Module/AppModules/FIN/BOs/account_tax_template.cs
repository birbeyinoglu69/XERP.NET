...
namespace XERP
{
    ...
    [Persistent("account_tax_template")]
	public partial class account_tax_template : XPCustomObject
	{
		#region Properties
		...
		public System.Int32 id {
            ...
            //FK FK_account_tax_template_create_uid
            ...
            //FK FK_account_tax_template_write_uid
            ...
            private account_tax_code_template fref_base_code_id;
            //FK FK_account_tax_template_ref_base_code_id
            [Custom("Caption", "Ref Base code id")]
            public account_tax_code_template ref_base_code_id {
                get { return fref_base_code_id; }
                set { SetPropertyValue<account_tax_code_template>("ref_base_code_id", ref fref_base_code_id, value); }
            }
            ...
            private account_tax_code_template fref_tax_code_id;
            //FK FK_account_tax_template_ref_tax_code_id
            [Custom("Caption", "Ref Tax code id")]
            public account_tax_code_template ref_tax_code_id {
                get { return fref_tax_code_id; }
                set { SetPropertyValue<account_tax_code_template>("ref_tax_code_id", ref fref_tax_code_id, value); }
            }
            ...
            //FK FK_account_tax_template_account_paid_id
            ...
            private account_tax_code_template fbase_code_id;
            //FK FK_account_tax_template_base_code_id
            [Custom("Caption", "Base Code id")]
            public account_tax_code_template base_code_id {
                get { return fbase_code_id; }
                set { SetPropertyValue<account_tax_code_template>("base_code_id", ref fbase_code_id, value); }
            }
            ...
            //FK FK_account_tax_template_account_collected_id
            ...
            //FK FK_account_tax_template_chart_template_id
            ...
            private account_tax_code_template ftax_code_id;
            //FK FK_account_tax_template_tax_code_id
            [Custom("Caption", "Tax Code id")]
            public account_tax_code_template tax_code_id {
                get { return ftax_code_id; }
                set { SetPropertyValue<account_tax_code_template>("tax_code_id", ref ftax_code_id, value); }
            }
    
        
            private account_tax_template fparent_id;
            //FK FK_account_tax_template_parent_id
            [Custom("Caption", "Parent Id")]
            public account_tax_template parent_id {
                get { return fparent_id; }
                set { SetPropertyValue<account_tax_template>("parent_id", ref fparent_id, value); }
            }
		...
		#region Constructors
		public account_tax_template(Session session) : base(session) { }
        #endregion
