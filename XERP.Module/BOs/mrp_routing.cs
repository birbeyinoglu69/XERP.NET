...
namespace XERP
{
    ...
    [Persistent("mrp_routing")]
	public partial class mrp_routing : XPCustomObject
	{
		#region Properties
		...
		#region Constructors
		public mrp_routing(Session session) : base(session) { }
        #endregion
