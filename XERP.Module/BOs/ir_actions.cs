...
namespace XERP
{
    ...
    [Persistent("ir_actions")]
	public partial class ir_actions : XPCustomObject
	{
		#region Properties
		...
		#region Constructors
		public ir_actions(Session session) : base(session) { }
        #endregion
