...
namespace XERP
{
    ...
    [Persistent("idea_idea")]
	public partial class idea_idea : XPCustomObject
	{
		#region Properties
		...
		public System.Int32 id {
            ...
            private idea_category fcategory_id;
            //FK FK_idea_idea_category_id
            [Custom("Caption", "Category Id")]
            public idea_category category_id {
                get { return fcategory_id; }
                set { SetPropertyValue<idea_category>("category_id", ref fcategory_id, value); }
            }
		...
		#region Constructors
		public idea_idea(Session session) : base(session) { }
        #endregion
