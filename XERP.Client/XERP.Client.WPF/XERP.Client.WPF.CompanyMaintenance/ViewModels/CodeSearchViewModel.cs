...
namespace XERP.Client.WPF.CompanyMaintenance.ViewModels
{
    public class CodeSearchViewModel : ViewModelBase<CodeSearchViewModel>
    {
        ...
        private BindingList<CompanyCode> GetCompanyCodes(CompanyCode companyQueryObject)
        {
            return new BindingList<CompanyCode>(_serviceAgent.GetCompanyCodes(companyQueryObject).ToList());
        }
        #endregion Methods
