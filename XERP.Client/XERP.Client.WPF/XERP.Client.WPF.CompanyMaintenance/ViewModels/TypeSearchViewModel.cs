...
namespace XERP.Client.WPF.CompanyMaintenance.ViewModels
{
    public class TypeSearchViewModel : ViewModelBase<TypeSearchViewModel>
    {
        ...
        private BindingList<CompanyType> GetCompanyTypes(CompanyType itemQueryObject)
        {
            return new BindingList<CompanyType>(_serviceAgent.GetCompanyTypes(itemQueryObject).ToList());
        }
        #endregion Methods
