...
{
    /// <summary>
    /// Interaction logic for SystemUserMaintenanceView.xaml
    /// </summary>
    public partial class MainMaintenanceView : UserControl
    {
        ...
        public MainMaintenanceView()
        {
            try
            {
                this.Resources.MergedDictionaries.Add(XERP.Client.WPF.SystemUserMaintenance.Resources.SharedDictionaryManager.MenuImagesSharedDictionary);
                this.Resources.MergedDictionaries.Add(XERP.Client.WPF.SystemUserMaintenance.Resources.SharedDictionaryManager.BaseControlsSharedDictionary);
        ...
        {
            _viewModel.SelectedSystemUserList = dgMain.SelectedItems;
        ...
        {//The columns may get moved so we need to predicate the column order before
            ...
            _viewModel.SystemUserColumnMetaDataList = new List<ColumnMetaData>();
            foreach (DataGridColumn column in dgMain.Columns)
            {
                ...
                _viewModel.SystemUserColumnMetaDataList.Add(columnMetaData);
            }        
