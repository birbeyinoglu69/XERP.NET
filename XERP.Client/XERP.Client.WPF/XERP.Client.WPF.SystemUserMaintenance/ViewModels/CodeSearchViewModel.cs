...
namespace XERP.Client.WPF.SystemUserMaintenance.ViewModels
{
    public class CodeSearchViewModel : ViewModelBase<CodeSearchViewModel>
    {
        ...
        private BindingList<SystemUserCode> GetSystemUserCodes(SystemUserCode systemUserQueryObject)
        {
            return new BindingList<SystemUserCode>(_serviceAgent.GetSystemUserCodes(systemUserQueryObject).ToList());
        }
        #endregion Methods
        ...
        {
            ResultList = GetSystemUserCodes(SearchObject);
        }
