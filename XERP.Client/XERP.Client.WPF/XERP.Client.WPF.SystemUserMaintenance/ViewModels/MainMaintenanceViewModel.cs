...
namespace XERP.Client.WPF.SystemUserMaintenance.ViewModels
{
    public class MainMaintenanceViewModel : ViewModelBase<MainMaintenanceViewModel>
    {
        ...
        private BindingList<SecurityGroup> _selectedSecurityGroupAvailableList;
        public BindingList<SecurityGroup> SelectedSecurityGroupAvailableList
        {
        ...
        private BindingList<SystemUserSecurity> _systemUserSecurityGroupsAuthorizedList;
        public BindingList<SystemUserSecurity> SystemUserSecurityGroupsAuthorizedList
        {
            get { return _systemUserSecurityGroupsAuthorizedList; }
            set
            {
                _systemUserSecurityGroupsAuthorizedList = value;
                NotifyPropertyChanged(m => m.SystemUserSecurityGroupsAuthorizedList);
            }
        }
        private BindingList<SystemUserSecurity> _selectedSystemUserSecurityGroupsAuthorizedList;
        public BindingList<SystemUserSecurity> SelectedSystemUserSecurityGroupsAuthorizedList
        {
            get { return _selectedSystemUserSecurityGroupsAuthorizedList; }
            set
            {
                _selectedSystemUserSecurityGroupsAuthorizedList = value;
                NotifyPropertyChanged(m => m.SelectedSystemUserSecurityGroupsAuthorizedList);
            }
        }
        ...
        public SystemUser SelectedSystemUser
        {
            get 
            {
                ...
                SecurityGroupAvailableList = GetAvailableSecurityGroups(_selectedSystemUser.SystemUserID);
        ...
        private BindingList<SystemUserSecurity> GetSystemUserSecurities(SystemUserSecurity systemUserSecurity)
        {
            BindingList<SystemUserSecurity> systemUserSecurityList = new BindingList<SystemUserSecurity>(_serviceAgent.GetSystemUserSecurities(systemUserSecurity).ToList());
            //Dirty = false;
            //AllowCommit = false;
            return systemUserSecurityList;
        }
