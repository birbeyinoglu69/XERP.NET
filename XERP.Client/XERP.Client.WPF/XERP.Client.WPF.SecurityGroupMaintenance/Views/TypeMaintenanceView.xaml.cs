...
{
    /// <summary>
    /// Interaction logic for SecurityGroupTypeMaintenanceView.xaml
    /// </summary>
    public partial class TypeMaintenanceView : UserControl
    {
        ...
        {
            _viewModel.SelectedSecurityGroupTypeList = dgMain.SelectedItems;
        ...
        {//The columns may get moved so we need to predicate the column order before
            ...
            _viewModel.SecurityGroupTypeColumnMetaDataList = new List<ColumnMetaData>();
            foreach (DataGridColumn column in dgMain.Columns)
            {
                ...
                _viewModel.SecurityGroupTypeColumnMetaDataList.Add(columnMetaData);
            }        
