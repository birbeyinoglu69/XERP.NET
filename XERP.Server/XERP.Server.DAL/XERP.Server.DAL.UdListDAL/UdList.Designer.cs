...
namespace XERP.Server.DAL.UdListDAL
{
    ...
    /// </summary>
    public partial class UdListEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new UdListEntities object using the connection string found in the 'UdListEntities' section of the application configuration file.
        /// </summary>
        public UdListEntities() : base("name=UdListEntities", "UdListEntities")
        {
        ...
        /// </summary>
        public UdListEntities(string connectionString) : base(connectionString, "UdListEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new UdListEntities object.
        /// </summary>
        public UdListEntities(EntityConnection connection) : base(connection, "UdListEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
