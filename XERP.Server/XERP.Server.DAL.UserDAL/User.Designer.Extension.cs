...
namespace ExtensionMethods
{
    public static class MyExtensions
    {
        ...
        {
            XERP.Server.DAL.UserDAL.DALUtility dalUtility = new DALUtility();
            List<Temp> tempList = new List<Temp>();
            int id = 0;
            using (UserEntities ctx = new UserEntities(dalUtility.EntityConectionString))
            {
